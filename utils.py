...
def replace_module(model, replacement_dict={}, exception_dict={}, arch="presnet18"):
    ...
    """ 
    assert arch in ["presnet32", "presnet32-standard", "presnet18", "glouncv-alexnet", "glouncv-alexnet-bn",  "postech-alexnet", "glouncv-presnet34", "glouncv-presnet50", "glouncv-mobilenetv2_w1"],\
